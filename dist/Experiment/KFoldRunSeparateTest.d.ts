...
export declare class KFoldRunSeparateTest extends KFoldRun {
     ...
     */
    protected runExperiment(model: Model, parameter: Parameter, experimentPerformance: ExperimentPerformance, crossValidation: CrossValidation<Instance>, testSet?: InstanceList): void;
    /**
